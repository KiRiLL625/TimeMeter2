...
int main() {
    ...
    sleep(2);
    timeMeter.setTimeStamp(1);
    //long long a = timeMeter.getMSTimeStamp(0);
    //long long b = timeMeter.getMSTimeStamp(1);
    ...
    std::cout << timeFunc(std::bind(factorial, 1000)) << std::endl;
    std::cout << timeFunc([&]{return factorial(1000);}) << std::endl;
